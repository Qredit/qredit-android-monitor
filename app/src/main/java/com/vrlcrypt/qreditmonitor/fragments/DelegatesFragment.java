...
import com.vrlcrypt.qreditmonitor.adapters.DelegatesAdapter;
...
public class DelegatesFragment extends Fragment implements RequestListener<List<Delegate>>{
    ...
    private void refreshContent() {
        ...
        QreditService.getInstance().requestActiveDelegates(settings, this);
        QreditService.getInstance().requestStandyByDelegates(settings, this);
    }
