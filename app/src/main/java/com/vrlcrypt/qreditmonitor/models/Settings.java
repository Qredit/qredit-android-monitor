...
public class Settings {
    ...
    public static final String QREDIT_ADDRESS_ATTR = "settings.qredit_address";
    ...
    public String getQreditAddress() {
        return qreditAddress;
    }

    public void setQreditAddress(String qreditAddress) {
        this.qreditAddress = qreditAddress;
    }
