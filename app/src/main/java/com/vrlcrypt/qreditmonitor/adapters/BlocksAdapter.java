package com.vrlcrypt.qreditmonitor.adapters;
...
public class BlocksAdapter extends
    ...
    public void onBindViewHolder(BlocksAdapter.ViewHolder holder, int position) {
        ...
        feeTextView.setText(String.valueOf(Utils.convertToQreditBase(block.getTotalFee())));
        rewardTextView.setText(String.valueOf(Utils.convertToQreditBase(block.getReward())));
    }
